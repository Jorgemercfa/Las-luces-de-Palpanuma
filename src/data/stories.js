export default [
  ...
  // {
  //   id: 2,
  //   name: 'La guerra de los lobos',
  //   shortDescription:
  //     'En La guerra de los lobos, la traición y el honor se enfrentan en una epopeya militar donde familia y aliados se quiebran.',
  //   longDescription: `
  //     La Casa Ornstein de Stuttgart ha sido atacada en su propio territorio, traicionada por sus propios parientes refugiados en la República de Jutlandia. Sigfrida Ornstein, en coma, apenas logró sobrevivir al atentado gracias a la intervención de su hermano, Sigurd, quien quedó al borde de la muerte y con severas cicatrices. Ahora, el Imperio Germánico se moviliza y la Casa Ornstein marcha a la guerra con un solo objetivo: cobrar represalia por la traición de sus parientes y recuperar Jutlandia para gloria del Kaiser y Germania.
  //     La guerra de los lobos, segunda parte de la saga Imperium, nos sumerge en un conflicto donde las lealtades se quiebran, la familia se convierte en enemiga, y el honor se decide entre acero, sangre
  //     y fuego. Lorenzo Macchiavello construye una epopeya militar en la que el mayor peligro no está en el frente, sino en quienes deberían estar del mismo lado.
  //   `,
  //   image: require('@/assets/book_home_2.png'),
  //   image2: require('@/assets/homeimg2.png'),
  //   details_button: 'Detalles',
  // },
];
